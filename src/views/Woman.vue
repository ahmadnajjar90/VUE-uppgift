    ...
    <div class="search-container my-5">
        <label class="mr-3 mt-2">Välj kategori</label>
          ...
          <select class="select-css mr-5" v-model="selectedBrand">
            <option value="All">Alla</option>
            <option value="Aaiko">Aaiko</option>
            <option value="Adele Dezotti">Adele Dezotti</option>
            <option value="Anna Field">Anna Field</option>
      ...
      <div v-for="product in filteredClothes" v-bind:key="product.id">
        <div class="card text-center">
          ...
          <div class="card-footer justify-content-center">
            <button @click="addItem(product)" class="btn back-color-button btn-sm">Köpa</button>
          </div>
        </div>
      </div>
    </div>
